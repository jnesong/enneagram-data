...
strength901 = Strength.create(enneagram_id:nine.id, title:"Nines are peaceful, comforting, and reassuring.", description: "Healthy Nines are patient, steady, receptive, relaxed, agreeable, comforting, self-aware, dynamic, proactive, healing, natural, imaginative, serene, engaged, and passionate. They make excellent mediators, having the ability to be objective and see all sides of an issue. They are essential to a world of conflict and pain.")

weakness101 = Weakness.create(enneagram_id:one.id, title:"For a One, the besetting sin is anger.", description: "The underlying emotion Ones are trying to conquer is guilt. Ones often carry a suppressed anger because nothing is ever good enough— including and especially themselves. This anger is driven by an exaggerated sense of guilt and a feeling of not measuring up, which leads Ones to be very hard on themselves. Few casual observers would suspect how much Ones are suffering from the attacks of their Inner Critic. This is not only how Ones tend to relate to themselves, but to God and others, through performance and criticism.")
weakness201 = Weakness.create(enneagram_id:two.id, title:"Twos are battling is shame and a sense of worthlessness if they aren’t needed by others.", description: "Ironically, this leads to a form of pride that unconsciously motivates Twos in the sense that their service of others can be motivated by their own self-interest and need for approval. This can lead to people-pleasing, over-attachment to people, and the fear of man. Unhealthy Twos also deny their own needs. They are energized by meeting others’ needs but fear having the tables turned since it compromises their survival strategy of being the caregiver.")
weakness301 = Weakness.create(enneagram_id:three.id, title:"For Threes, the besetting sin is deceit or projecting a false image.", description: "The underlying emotion they are trying to resolve is shame. Whereas Ones desire to be perfect, Threes desire to look perfect. Unhealthy Threes relate through performance and perception, striving to be or at least be seen as good enough. The question Threes are asking is, 'Who am I if I’m not seen as successful?' Threes tend to shine on the outside in whatever they do, while their inner life remains disconnected. Preoccupied with speed and efficiency in accomplishing their goals, Threes rarely slow down and press inward to get in touch with their emotions.")
weakness401 = Weakness.create(enneagram_id:four.id, title:" For Fours, the besetting sin is envy.", description: "At some level, Fours believe they are missing something that other people seem to have. Naturally, this can lead to be envious of others. The driving emotion beneath the surface is shame and a low view of self. Unhealthy Fours are known to give themselves to a sort of a critical, melancholy, depressed, self-loathing spirit. While they don’t like it, they can easily get comfortable in a dark place and sort of wear that for their identity. Their own darkness becomes another means of being different and trying to overcome shame. This is a self-destructive pattern.")
weakness501 = Weakness.create(enneagram_id:five.id, title:"Fives perceive the world as a dangerous place and battle an underlying emotion of fear.", description: "Their besetting sin is greed. This is not a monetary greed; rather, it is the lack of ability to be open and generous with one’s self. The Five’s defense mechanism is to hide inside their wealth of knowledge and live inside their minds. Fives are afraid of their feelings, so they hide in their thoughts. They’re afraid of being vulnerable and known, so they withhold their true selves. Unhealthy Fives can be argumentative, high strung, cynical, reclusive, even nihilistic.")
weakness601 = Weakness.create(enneagram_id:six.id, title:"The underlying emotion Sixes are trying to overcome is fear.", description: "Their besetting sin is anxiety. They are the most anxious type of all the personalities. They live in their heads and let their thoughts run away them. They tend to worry about what they’re going to worry about. It’s not just that they struggle to trust others, but Sixes really struggle to trust themselves. Sixes are plagued with self-doubt. They tirelessly look for some kind of structure to hide in, an environment that will reassure them and make them feel safe and secure and stable. The questions their soul is asking are, Where am I? Am I safe? Unhealthy Sixes are suspicious of others, especially authority.")
weakness701 = Weakness.create(enneagram_id:seven.id, title:"Sevens are driven by an underlying fear that goes back to their childhood.", description: "Their coping strategy is to have as much fun and entertainment as possible, which is why their besetting sin is gluttony. Sevens are prone to constant stimulation and consumption as a way of distracting themselves from an inner anxiety. This is their defense strategy against their emotional pain. They 'gobble up' every experience but are always left hungry for more. Thus, they are always looking for the next thing or the perfect combination of things that will heal them and make them truly happy. They tend to be thrill seekers. Their avoidance of pain and endless hunger for more make them prone to various additions, including chronic anxiety. Unhealthy Sevens would rather keep relationships on the surface because it would be too painful to know their whole story.")
